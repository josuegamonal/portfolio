...
<head>
	...
	<title>Sapphira Privé Torrelodones</title>
...
<?php include 'includes/nav.php' ?>
	...
	<section class="proyecto">
		<div class="container">
			<div class="main-text">
				<h3>Web Sapphira Privé Torrelodones</h3>
				<p>Web para una clínica estética respetando el branding de la franquicia donde se muestran y explican los diferentes tratamientos que ofrecen.</p>
	...
	<section class="imagenes-trabajos">
				<div class="main-volver">
			<div class="icon more trabajo-1 volver">
				<img class="icon-svg" src="images/icons/arrow-left-circle-fill.svg" alt="Volver">
			</div>
		</div>

		<div class="container" id="projects-pagina">
			<div class="trabajos trabajo-alargado"><img class="img-trabajos" src="images/shappira/sapphira.jpg" alt="Sapphira Privé"></div>
		</div>
		<div class="container" id="projects-pagina">
			<div class="trabajo-1"><a href="https://www.sapphiraprivetorrelodones.com/" target="_blank" ><p>Ir a la web de Sapphira Privè Torrelodones</p></a></div>
		</div>

		<div class="main-volver">
			<div class="icon more trabajo-1 volver1">
				<img class="icon-svg" src="images/icons/arrow-left-circle-fill.svg" alt="Volver">
			</div>
		</div>
	</section>
